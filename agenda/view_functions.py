...
INSTRUMENT_SEARCH_ALIASES = {
    ...
    "singer": ["vocal", "vocalista", "vocalist"],
    "vocalist": ["vocal", "vocalista", "singer"],
    "violao": ["acoustic_guitar", "violão"],
    "violão": ["acoustic_guitar", "violao"],
    "acoustic_guitar": ["violao", "violão", "violonista"],
    "acoustic guitar": ["acoustic_guitar", "violao", "violão", "violonista"],
    "violonista": ["acoustic_guitar", "violao", "violão"],
    "guitarra": ["guitar", "electric_guitar"],
    "guitar": ["guitarra", "electric_guitar"],
    "baixo": ["bass", "bass_guitar"],
    "bass": ["baixo", "bass_guitar", "contrabaixo"],
    "bateria": ["drums"],
    "drums": ["bateria"],
    "teclado": ["keyboard", "piano", "synth"],
    "keyboard": ["teclado", "piano", "synth"],
    "percussao": ["percussion"],
    "percussion": ["percussao"],
    "cajon": ["cajón"],
    "cajón": ["cajon"],
    "saxofone": ["saxophone", "sax"],
    "saxophone": ["saxofone", "sax"],
    "sax": ["saxophone", "saxofone"],
    "violin": ["violino", "violinista"],
    "violino": ["violin", "violinista"],
    "violinista": ["violin", "violino"],
}
    ...
    return Response(
        {
            ...
            "artist_type": musician_request.artist_type,
            "stage_name": musician_request.stage_name,
            "formation_members": musician_request.formation_members,
...
def create_quote_request(request):
    ...
    # Notifica músico sobre o novo pedido (Email + Telegram)
    notify_new_quote_request(quote_request)
...
def musician_send_proposal(request, request_id):
    ...
    # Notifica contratante sobre a proposta (Email + Telegram)
    notify_proposal_received(quote_request, proposal)
...
def contractor_accept_proposal(request, request_id):
    ...
    # Notifica músico sobre a reserva (Email + Telegram)
    notify_reservation_created(quote_request)
...
def musician_confirm_booking(request, request_id):
    ...
    # Notifica contratante sobre a confirmação (Email + Telegram)
    notify_booking_confirmed(quote_request)
