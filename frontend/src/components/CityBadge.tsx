  ...
  return (
    <div className={`relative ${className}`} ref={menuRef}>
      <motion.button
        ...
        className={`inline-flex max-w-full min-w-0 items-center gap-2 rounded-full px-3 py-2 text-sm font-semibold border transition-all duration-200 ${label ? baseClasses : actionClasses} hover:shadow-lg hover:border-amber-300/60`}
        title={badgeTitle}
