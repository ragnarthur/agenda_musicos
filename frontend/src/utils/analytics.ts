...
type EventName =
  ...
  | 'pwa_landing_install_visible'
  | 'pwa_landing_install_click'
  | 'pwa_landing_install_ios_instructions_opened'
  | 'pwa_landing_install_native_success'
  | 'pwa_landing_install_manual_android_opened'
  | 'pwa_installed'
