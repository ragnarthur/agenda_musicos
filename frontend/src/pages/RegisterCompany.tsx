          ...
          <div className="lg:grid lg:grid-cols-[1fr_1.2fr] lg:gap-10 lg:items-start">
            ...
            <div className="hidden lg:flex lg:flex-col lg:py-6">
              <div className="mb-6 flex items-center gap-4">
                ...
                <div>
                  <h2 className="text-2xl font-bold text-white">Cadastro de Contratante</h2>
                  <p className="text-sm text-primary-200">Comece a contratar hoje mesmo</p>
                </div>
              </div>
              <p className="mb-8 text-base font-medium leading-relaxed text-primary-100">
                Crie sua conta gratuitamente e acesse músicos profissionais verificados da sua
                região.
              </p>
              <div className="space-y-4">
                {(
                  [
                    {
                      icon: Users,
                      title: 'Catálogo de Músicos',
                      desc: 'Acesse profissionais verificados por instrumento e região',
                    },
                    {
                      icon: CheckCircle,
                      title: 'Cadastro Gratuito',
                      desc: 'Sem taxas de adesão — comece a contratar na hora',
                    },
                    {
                      icon: Star,
                      title: 'Contratação Simplificada',
                      desc: 'Gerencie pedidos e histórico em um só lugar',
                    },
                  ] as const
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      defaultValue={
                        googleUserInfo
                          ? `${googleUserInfo.first_name} ${googleUserInfo.last_name}`
                          : ''
                      }
