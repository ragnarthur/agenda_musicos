...
from .models import NotificationPreference, NotificationLog, TelegramVerification


@admin.register(NotificationPreference)
class NotificationPreferenceAdmin(admin.ModelAdmin):
    list_display = ['user', 'preferred_channel', 'telegram_verified', 'fallback_to_email', 'updated_at']
