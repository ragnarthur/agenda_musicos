...
class EmailProvider(BaseProvider):
    ...
    def send(self, payload: NotificationPayload, user) -> NotificationResult:
        if not self.can_send_to(user):
            return NotificationResult(success=False, error_message="Usuario sem email configurado")
        ...
        try:
            ...
            if success:
                ...
                return NotificationResult(success=False, error_message="Falha ao enviar email")
